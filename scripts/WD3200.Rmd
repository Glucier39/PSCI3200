...
book <- read.csv("https://raw.githubusercontent.com/Glucier39/PSCI3200/refs/heads/main/data/how_china_lends_dataset_version_1_0__test/CLA-Database-Raw-Data-Public-2024-FIN.csv?token=GHSAT0AAAAAADAAVNNK7QVA2XWBYTLIQCZMZ7NJKAA") # China Loan Data
 ...
 # 
Vdem <- read_csv("https://raw.githubusercontent.com/Glucier39/PSCI3200/refs/heads/main/data/V_Demclean.csv?token=GHSAT0AAAAAADAAVNNKSTQN4BWMUVM3PQUCZ7NJKYA")
...
comb$execorr_stag <- NA
comb$execorr_stag <- oil_vdem$v2x_execorr[oil_vdem$Year == comb$Year + 2]
...
OLS
```{r}
linear <- summary(lm(v2x_execorr ~ year_count,data = comb)) # executive corruption indicator = strong correlation
linear
